...
@section('content')
                    ...
                    <div class="col px-0">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6 text-center">
                                <img src="{{ asset('assets/landing') }}/img/brand/white.png" style="width: 200px;"
                                    class="img-fluid">
                                <p class="lead text-white">The easier the writing appears, the more effort the
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="collapse navbar-collapse" id="nav-inner-success">
                                            ...
                                            <ul class="navbar-nav ml-lg-auto">
                                                ...
                                                <li class="nav-item dropdown">
                                                    <a class="nav-link dropdown-toggle nav-link-icon" href="javascript:;"
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-primary">
                        ...
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="javascript:;" id="navbar-primary_dropdown_1"
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-success">
                        ...
                        <ul class="navbar-nav ml-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link nav-link-icon dropdown-toggle" href="javascript:;"
                                    id="navbar-success_dropdown_1" role="button" data-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false">
                                    <i class="ni ni-settings-gear-65"></i>
                                    <span class="nav-link-inner--text d-lg-none">Settings</span>
                                </a>
                    ...
                    <div class="row row-grid justify-content-between">
                        <div class="col-lg-5">
                            ...
                            <ul class="nav nav-pills nav-pills-circle mb-3" id="tabs_2" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#tabs_2_2"
                                        role="tab" aria-controls="profile" aria-selected="false">
                                        <span class="nav-link-icon d-block"><i class="ni ni-chat-round"></i></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#tabs_2_3"
    ...
    <div class="section section-typography">
        <div class="container">
            ...
            <div class="row py-3 align-items-center">
                ...
                <div class="col-sm-9">
                    <blockquote class="blockquote">
                        <p class="mb-0">I always felt like I could do anything. That’s the main thing people are
                            controlled by!</p>
            ...
            <div class="row py-3 align-items-center">
                ...
                <div class="col-sm-9">
                    <p class="text-success mb-0">I will be the leader of a company that ends up being worth billions
                        of dollars,
                        because I got the answers...</p>
                </div>
            </div>
            <div class="row py-3 align-items-center">
                ...
                <div class="col-sm-9">
                    <p class="text-warning mb-0">I will be the leader of a company that ends up being worth billions
                        of dollars,
                        because I got the answers...</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-3 col-6">
                    ...
                    <img src="{{ asset('assets/landing') }}/img/faces/team-1.jpg" alt="Rounded image"
                ...
                <div class="col-sm-3 col-6">
                    ...
                    <img src="{{ asset('assets/landing') }}/img/faces/team-2.jpg" alt="Circle image"
                ...
                <div class="col-sm-3 col-6 mt-5 mt-sm-0">
                    ...
                    <img src="{{ asset('assets/landing') }}/img/faces/team-3.jpg" alt="Raised image"
                ...
                <div class="col-sm-3 col-6 mt-5 mt-sm-0">
                    ...
                    <img src="{{ asset('assets/landing') }}/img/faces/team-4.jpg" alt="Raised circle image"
            ...
            <div class="row mt-5">
                <div class="col-sm-3 col-6">
                    ...
                    <div class="avatar-group">
                        <a href="javascript:;" class="avatar avatar-lg rounded-circle" data-toggle="tooltip"
                            data-original-title="Ryan Tompson">
                            <img alt="Image placeholder" src="{{ asset('assets/landing') }}/img/faces/team-1.jpg">
                        </a>
                        <a href="javascript:;" class="avatar avatar-lg rounded-circle" data-toggle="tooltip"
                            data-original-title="Romina Hadid">
                            <img alt="Image placeholder" src="{{ asset('assets/landing') }}/img/faces/team-2.jpg">
                        </a>
                        <a href="javascript:;" class="avatar avatar-lg rounded-circle" data-toggle="tooltip"
                            data-original-title="Alexander Smith">
                            <img alt="Image placeholder" src="{{ asset('assets/landing') }}/img/faces/team-3.jpg">
                        </a>
                        <a href="javascript:;" class="avatar avatar-lg rounded-circle" data-toggle="tooltip"
                            data-original-title="Jessica Doe">
                            <img alt="Image placeholder" src="{{ asset('assets/landing') }}/img/faces/team-4.jpg">
                        </a>
                    </div>
                </div>
                                            ...
                                            <div class="btn-wrapper text-center">
                                                <a href="javascript:;" class="btn btn-neutral btn-icon">
                                                    <span class="btn-inner--icon">
                                                        <img
                                                            src="{{ asset('assets/landing') }}/img/icons/common/github.svg">
                                                    </span>
                                                ...
                                                <a href="javascript:;" class="btn btn-neutral btn-icon">
                                                    <span class="btn-inner--icon">
                                                        <img
                                                            src="{{ asset('assets/landing') }}/img/icons/common/google.svg">
                                                    </span>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input class="flatpickr datetimepicker form-control" type="text"
            ...
            <div class="row tooltips-popovers">
                <div class="col-lg-6">
                    ...
                    <button type="button" class="btn btn-sm btn-primary btn-tooltip" data-toggle="tooltip"
                        ...
                        data-animation="true">Primary</button>
                    <button type="button" class="btn btn-sm btn-info btn-tooltip" data-toggle="tooltip"
                        data-placement="top" title="Tooltip on top" data-container="body"
                        data-animation="true">Info</button>
                    <button type="button" class="btn btn-sm btn-success btn-tooltip" data-toggle="tooltip"
                        data-placement="top" title="Tooltip on top" data-container="body"
                        data-animation="true">Success</button>
                    <button type="button" class="btn btn-sm btn-warning btn-tooltip" data-toggle="tooltip"
                        data-placement="top" title="Tooltip on top" data-container="body"
                        data-animation="true">Warning</button>
                    <button type="button" class="btn btn-sm btn-danger btn-tooltip" data-toggle="tooltip"
                        data-placement="top" title="Tooltip on top" data-container="body"
                        data-animation="true">Danger</button>
                    <button type="button" class="btn btn-sm btn-default btn-tooltip" data-toggle="tooltip"
                        data-placement="top" title="Tooltip on top" data-container="body"
                        data-animation="true">Default</button>
                    <button type="button" class="btn btn-sm btn-secondary btn-tooltip" data-toggle="tooltip"
                        data-placement="bottom" title="Tooltip on bottom" data-container="body"
                        data-animation="true">Secondary</button>
                    <br /><br />
                ...
                <div class="col-lg-6 mt-4 mt-lg-0">
                    ...
                    <small class="d-block text-uppercase font-weight-bold mb-3">Colors</small>
                    <button type="button" class="btn btn-sm btn-primary" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Primary</button>
                    <button type="button" class="btn btn-sm btn-info" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Info</button>
                    <button type="button" class="btn btn-sm btn-success" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Success</button>
                    <button type="button" class="btn btn-sm btn-warning" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Warning</button>
                    <button type="button" class="btn btn-sm btn-danger" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Danger</button>
                    <button type="button" class="btn btn-sm btn-default" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Default</button>
                    <button type="button" class="btn btn-sm btn-secondary" data-container="body"
                        data-original-title="Popover on Top" data-toggle="popover" data-placement="top"
                        data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">Secondary</button>
                    <br /><br />
                    <small class="d-block text-uppercase font-weight-bold mb-3">Position</small>
                    <button type="button" class="btn btn-sm btn-default" data-container="body"
    ...
    <div class="section" style="background-image: url('{{ asset('assets/landing') }}/img/ill/1.svg');">
        <div class="container py-md">
            <div class="row justify-content-between align-items-center">
                        ...
                        <div id="carousel_example" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="img-fluid"
                                        src="{{ asset('assets/landing') }}/img/theme/img-1-1200x1000.jpg"
                                        alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="img-fluid"
                                        src="{{ asset('assets/landing') }}/img/theme/img-2-1200x1000.jpg"
                                        alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="img-fluid"
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="lead mt-4">Argon Design System comes with four pre-built pages to help you get started
                        faster. You
            ...
            <div class="row row-grid justify-content-between align-items-center">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-white">The Design System comes with four pre-built pages to help you get
                        started faster.
                        You can change the text and images and you're good to go. More importantly, looking at them will
                        give you a
                                ...
                                <div class="btn-wrapper text-center">
                                    <a href="#" class="btn btn-neutral btn-icon">
                                        <span class="btn-inner--icon"><img
                                                src="{{ asset('assets/landing') }}/img/icons/common/github.svg"></span>
                                        <span class="btn-inner--text">Github</span>
                                    </a>
                                    <a href="#" class="btn btn-neutral btn-icon">
                                        <span class="btn-inner--icon"><img
                                                src="{{ asset('assets/landing') }}/img/icons/common/google.svg"></span>
                                        <span class="btn-inner--text">Google</span>
                                    </a>
                                </div>
                            </div>
            ...
            <div class="row row-grid justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead">Cause if you do, it can be yours for FREE. Hit the button below to navigate to
                        Creative Tim
                        where you can find the Design System in HTML. Start a new project or give an old Bootstrap
                        project a new
                        look!</p>
                    <div class="btn-wrapper">
